...
class AppTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    headlineLarge: const TextStyle().copyWith(fontSize: 32.0, fontWeight: FontWeight.w900, color: AppColors.dark),
    ...
    titleLarge: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.w700, color: AppColors.dark),
    titleMedium: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w500, color: AppColors.dark),
    titleSmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w600, color: AppColors.dark),
